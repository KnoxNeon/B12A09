...
const GameDetails = () => {
        ...
        <div className="flex flex-col gap-6 sm:gap-8 lg:flex-row lg:items-end">
          ...
          <div className="flex-1 space-y-4 lg:space-y-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-xl font-bold text-lg shadow-xl transition-all transform hover:scale-105"
            >
  ...
  {/* About Card - Now properly responsive */}
